...
Devise.setup do |config|
  ...
  # own secret key.
  # config.secret_key = 'e87dfd0272a65218063e6ede6b2e0328d903ecd7e67e926404ae8146513e5bf5da5a3f4d73051de60e74989af1711fbe9355d4416400cc6de489d783fff3ccfa'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = Rails.application.secrets.gmail_address
  ...
  # config.pepper = '3d93ec5c9e93cefcf2245aa6afa3ea390cb03f22e63b34046943d34302a3ea3474c7f4950273d0411f849c1cb83be9109cd064496f34bde14857d8331f0ad4ce'
